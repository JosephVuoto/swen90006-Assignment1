...
ID&Test case&Expected output\\
\hline  
EC1&paraphrases = \{\}, sessionIDs = \{\}, userIDs = \{\}, passbookUsername = "abc", paraphrase = "1aA"&NoSuchUserException\\
\hline
...
\hline
7&userIDs.containsKey(sessionID)&untestable\\
\hline
8&userIDs.containsKey(sessionID)&untestable\\
\hline
\end{longtable}
